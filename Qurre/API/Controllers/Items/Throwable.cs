...
namespace Qurre.API.Controllers.Items
{
    public class Throwable : Item
    {
        ...
        public void Throw(bool fullForce = true) => Base.ServerThrow(fullForce, Base.transform.position/*, ThrowableNetworkHandler.GetLimitedVelocity(Base.Owner.playerMovementSync.PlayerVelocity)*/);
    }
}