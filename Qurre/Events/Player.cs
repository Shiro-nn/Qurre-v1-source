...
namespace Qurre.Events
{
    public static class Player
    {
        ...
        internal static void Invokes(MedicalStoppingEvent ev) => MedicalStopping.invoke(ev);
        internal static void Invokes(MedicalUsingEvent ev) => MedicalUsing.invoke(ev);
        internal static void Invokes(MedicalUsedEvent ev) => MedicalUsed.invoke(ev);
        internal static void Invokes(SyncDataEvent ev) => SyncData.invoke(ev);
        internal static void Invokes(ThrowGrenadeEvent ev) => ThrowGrenade.invoke(ev);
